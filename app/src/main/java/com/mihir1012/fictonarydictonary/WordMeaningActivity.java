...
import com.mihir1012.fictonarydictonary.fragments.FragmentAntonyms;
import com.mihir1012.fictonarydictonary.fragments.FragmentDefinition;
import com.mihir1012.fictonarydictonary.fragments.FragmentExample;
import com.mihir1012.fictonarydictonary.fragments.FragmentSynonyms;
...
public class WordMeaningActivity extends AppCompatActivity {
    ...
    public String synonyms,antonyms,example,en_definition;
    TextToSpeech prom;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(c.moveToFirst()){
            en_definition = c.getString(c.getColumnIndex("en_definition"));
        ...
        rose.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(WordMeaningActivity.this, "like it"  , Toast.LENGTH_SHORT).show();
            }
        });
        textview.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                snackbar.show();
                prom  = new TextToSpeech(WordMeaningActivity.this, new TextToSpeech.OnInitListener() {
                    @Override
